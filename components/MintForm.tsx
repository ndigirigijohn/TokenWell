    ...
    <div className="w-full max-w-2xl mx-auto">
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-2">
          <label htmlFor="tokenName" className="block text-sm font-medium text-gray-200">
            Token Name
          </label>
          <input
            type="text"
            ...
            className="w-full px-4 py-3 bg-secondary-light border border-gray-700 rounded-lg 
        ...
        {/* Network Selector */}
        <div className="space-y-2">
          <label htmlFor="network" className="block text-sm font-medium text-gray-200">
            Network
          </label>
              ...
              <button
                ...
                className={`flex-1 px-4 py-3 rounded-lg font-medium transition-all duration-200 ${
                  formData.network === net
                    ...
                    : "bg-secondary-light text-gray-300 hover:bg-secondary border border-gray-700"
                }`}
              >
                {net}
              </button>
        ...
        <button
          type="submit"
          disabled={isLoading}
          className="w-full px-6 py-4 bg-gradient-primary text-white font-semibold rounded-lg
                   hover:shadow-glow-lg transform hover:-translate-y-0.5 transition-all duration-200
